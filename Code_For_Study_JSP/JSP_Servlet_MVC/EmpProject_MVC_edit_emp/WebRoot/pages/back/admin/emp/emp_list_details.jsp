...
<c:if test="${allEmps != null}" var="res">
	...
	<tr onMouseOver="changeColor(this,'white')"
		...
		<td align="center" valign="middle"><span class="STYLE2"> 
			<a href="<%=basePath%>/pages/back/admin/emp/EmpServlet?empno=${emp.empno}&backUrl=${backUrl}&cp=${currentPage}&ls=${lineSize}&col=${column}&kw=${keyWord}&status=delete&backStatus=${status}" onclick="return deleteConfirm()">删除</a> 
		</span></td>
	</tr> 
</c:forEach>
</c:if>
