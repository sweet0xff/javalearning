			...
			<td width="182" valign="top"><div id="container">
					...
					<div class="content">
						...
						<ul class="MM">
							...
							<li><a href="<%=basePath%>/pages/back/admin/dept/dept_list.jsp" target="main">部门管理</a></li>
							<li><a href="<%=basePath%>/pages/back/admin/dept/dept_list_details.jsp" target="main">详细信息</a></li>
						</ul>
					</div>
					<h1 class="type">
