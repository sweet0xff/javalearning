...
%>
	<tr onMouseOver="changeColor(this,'white')"
		...
		<td align="center" valign="middle"><span class="STYLE2">
			<a href="<%=basePath%>/pages/back/admin/emp/emp_update.jsp?empno=<%=vo.getEmpno()%>">修改</span></td>
		<td align="center" valign="middle"><span class="STYLE2"> 
			<a href="<%=basePath%>/pages/back/admin/emp/emp_delete_do.jsp?empno=<%=vo.getEmpno()%>" onclick="return deleteConfirm()">删除</a> 
		</span></td>
	</tr>
<%
	}
