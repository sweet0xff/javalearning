...
<%	// 定义分页的控制变量
	...
	String actionUrl = "emp_list_split.jsp" ;	// 参数的传递路径
...
<%	// 查询表中的全部数据，返回的是List集合，所以一定使用Iterator输出
	Map<String,Object> map = ServiceBackFactory.getIEmpServiceBackInstance().list(column,keyWord,currentPage,lineSize) ;
