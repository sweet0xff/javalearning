...
<c:if test="${allDepts != null}" var="res">
	...
	<tr onMouseOver="changeColor(this,'white')"
		...
		<td align="center" valign="middle"><span class="STYLE2"> 
			<a onclick="openWindow('<%=basePath%>/pages/back/admin/emp/emp_sal_list.jsp?deptno=${dept.deptno}&sal=${dept.stat.max}','部门信息',1000,600)" href="#">${dept.stat.max}</a>
		</span></td>
		<td align="center" valign="middle"><span class="STYLE2">
			<a onclick="openWindow('<%=basePath%>/pages/back/admin/emp/emp_sal_list.jsp?deptno=${dept.deptno}&sal=${dept.stat.min}','部门信息',1000,600)" href="#">${dept.stat.min}</a>
		</span></td>
		<td align="center" valign="middle"><span class="STYLE2">
			${dept.stat.avgyear}
		</span></td>
