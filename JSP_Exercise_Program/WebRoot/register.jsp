				 ...
				 <div class="col-md-6  register-top-grid">
					...
					<div class="mation">
						...
						<input type="text" name = "name" placeholder="please enter your name"> 
						 ...
						 <input type="text" name = "account" placeholder = "please enter your email address"> 
					</div>
					 <div class="clearfix"> </div>
					 </div>
				     ...
				     <div class=" col-md-6 register-bottom-grid">
						...
						<div class="mation">
							...
							<input type="password" name ="checkpassword" placeholder = "please enter password again">
						</div>
					 </div>
					 <div class="clearfix"> </div>
