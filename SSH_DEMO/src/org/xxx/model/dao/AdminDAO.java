...
public class AdminDAO {
	...
	public Admin login(Admin vo){
		Admin admin= (Admin) getCurrentSession()
					.createQuery("from Admin a where a.aname = ? and a.apassword = ?")
					.setString(0, vo.getAname())
					.setString(1,vo.getApassword()).uniqueResult();
		return admin;
	...
	public List<Admin> findByApassword(Object apassword) {
